...
Xenovia gives you a control layer for agent runtimes. Route model traffic through your agent's OpenAI-compatible endpoint and enforce policy without rewriting your application architecture.
...
<CardGroup cols={2}>
  ...
  <Card title="Policies and Enforcement" icon="scale-balanced" href="/platform/policies-and-approvals">
...
<CardGroup cols={2}>
  <Card title="Agent endpoint" icon="shuffle" href="/getting-started/quickstart">
    Point any OpenAI-compatible client at your agent's endpoint. You keep your prompts, tools, and framework code, while Xenovia adds policy evaluation, provider routing, session tracking, and traces.
  </Card>
...
- Tool visibility and recorded block and escalation signals
- Guardrails, including a scope guardrail for what the agent is for

## Recommended reading order

<Steps>
  <Step title="1. Pick your path">
    Start with [Getting Started](/getting-started/overview) to decide between the agent endpoint and SDK hooks.
  </Step>
  ...
  <Step title="3. Add controls">
    Move to [Policies and Enforcement](/platform/policies-and-approvals) and start with one rule that blocks or redacts something concrete.
  </Step>
...
- Session ID, session turn, and trace linkage
