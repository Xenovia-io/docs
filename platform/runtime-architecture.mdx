...
Embeddings, legacy completions, model listing, audio, image, video, file, batch, and container endpoints are not routed and return `404`. Only the two inference routes above and the health endpoints are exposed.
