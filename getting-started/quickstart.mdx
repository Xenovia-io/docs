...
1. Create an **agent** and note the **agent ID**.
2. Generate an **API key** (`xe_...`) for that agent.
3. **Activate** the agent. While it is a draft, the runtime rejects its keys with `401`.
