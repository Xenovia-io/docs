...
<Callout type="info">
  The session ID must be a valid UUID. If the value is malformed, the runtime discards it and assigns a fresh UUID — check the echoed `X-Xenovia-Session-Id` response header to confirm your ID was accepted.
</Callout>
